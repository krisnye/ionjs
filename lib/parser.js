...
var CustomPredicate = runtime.CustomPredicate
    ...
    function buildBinaryExpression(head, tail) {
       ...
       parser = new Parser(new Grammar([new Action(new Sequence(new Optional(new Reference("EOL")), new Repeat(new Choice(new Reference("Statement"), new Reference("ModuleDeclaration"))).setName("statements"), new Reference("EOL"), new Reference("EOF")), (
function(__context, __values) {
let statements = __values[1];
 return node("Program", {sourceType:"module", body:statements}) })).setName("Module"),

new Choice(new Reference("ImportDeclarations"), new Reference("ExportDeclaration")).setName("ModuleDeclaration"),

new Action(new Sequence(new Reference("Identifier").setName("head"), new Repeat(new Action(new Sequence(new Terminal("."), new Reference("Identifier").setName("value")), (
function(__context, __values) {
...
new Action(new Sequence(new Reference("Indent"), new Repeat(new Action(new Sequence(new Reference("Dent"), new Reference("ImportSubDeclaration").setName("value")), (
function(__context, __values) {
let value = __values[1];
...
new Action(new Sequence(new Reference("ModulePath").setName("path"), new Optional(new Action(new Sequence(new Reference("_"), new Reference("AsToken"), new Reference("_"), new Reference("Identifier").setName("value")), (
function(__context, __values) {
...
let children = __values[2];
 return node("ImportSubDeclaration", {path,children,as}) })).setName("ImportSubDeclaration"),

new Action(new Sequence(new Reference("ImportToken"), new Reference("EOL"), new Reference("SubImports").setName("declarations")), (
function(__context, __values) {
let declarations = __values[2];
 return node("ImportDeclarations", {declarations} ) })).setName("ImportDeclarations"),
...
let declarations = __values[3];
 return declarations }))).setName("ExportDeclaration"),

new Choice(new Reference("Declaration"), new Reference("AssignmentStatement"), new Reference("ExpressionStatement"), new Reference("IfStatement"), new Reference("ForInStatement"), new Reference("ForOfStatement"), new Reference("ReturnStatement"), new Reference("WhileStatement")).setName("Statement"),

new Choice(new Reference("TypeDeclaration"), new Reference("ClassDeclaration"), new Reference("VariableDeclaration")).setName("Declaration"),
...
new Action(new Sequence(new Reference("TypeToken"), new Reference("_"), new Reference("Identifier").setName("id"), new Reference("_"), new Terminal("="), new Reference("_"), new Reference("Type").setName("value"), new Reference("EOL")), (
function(__context, __values) {
let id = __values[2];
...
new Action(new Sequence(new Reference("Identifier").setName("key"), new Reference("_"), new Terminal(":"), new Reference("_"), new Reference("OutlineExpression").setName("value")), (
function(__context, __values) {
let key = __values[0];
let value = __values[4];
 return node("Property", {key,value}) })).setName("OutlineProperty"),

new Choice(new Terminal("="), new Terminal("+="), new Terminal("-="), new Terminal("*="), new Terminal("/=")).setName("AssignmentOperator"),

new Action(new Sequence(new Reference("Pattern").setName("left"), new Reference("_"), new Reference("AssignmentOperator").setName("operator"), new Reference("_"), new Reference("OutlineExpression").setName("right")), (
function(__context, __values) {
let left = __values[0];
let operator = __values[2];
let right = __values[4];
 return node("ExpressionStatement", node("AssignmentExpression", {left, operator, right})) })).setName("AssignmentStatement"),
...
new Choice(new Reference("Identifier"), new Reference("ArrayPattern"), new Reference("ObjectPattern")).setName("Pattern"),
...
new Action(new Sequence(new Reference("Identifier").setName("key"), new Optional(new Action(new Sequence(new Reference("_"), new Terminal(":"), new Reference("_"), new Reference("Pattern").setName("value")), (
function(__context, __values) {
let value = __values[3];
...
let key = __values[0];
let value = __values[1];
 return node("Property", {key, value:value || node("Identifier", key), kind:"init", shorthand:value == null} ) })).setName("AssignmentProperty"),

new Action(new Sequence(new Choice(new Reference("ClassToken"), new Reference("StructToken")).setName("kind"), new Reference("_"), new Reference("Identifier").setName("id"), new Optional(new Reference("TypeParameters")).setName("typeParameters"), new Reference("_"), new Optional(new Reference("Extends")).setName("baseClasses"), new Reference("EOL"), new Reference("Indent"), new Repeat(new Action(new Sequence(new Reference("Dent"), new Reference("ClassVariableDeclaration").setName("value")), (
function(__context, __values) {
let value = __values[1];
...
new Choice(new Action(new Sequence(new Reference("Identifier").setName("id"), new Reference("_"), new Optional(new Reference("TypeArguments")).setName("args")), (
function(__context, __values) {
let id = __values[0];
let args = __values[2];
...
new Action(new Sequence(new Reference("Pattern").setName("pattern"), new Reference("_"), new Optional(new Action(new Sequence(new Repeat(new Terminal(":"), 1), new Reference("_"), new Reference("Type").setName("value")), (
function(__context, __values) {
let value = __values[2];
return value;}))).setName("valueType")), (
function(__context, __values) {
let pattern = __values[0];
let valueType = __values[2];
 return node("Parameter", {pattern, valueType})})).setName("Parameter"),
...
new Action(new Sequence(new Optional(new Action(new Sequence(new Reference("Identifier").setName("value"), new Reference("_"), new NotPredicate(new NotPredicate(new Terminal("(")))), (
function(__context, __values) {
let value = __values[0];
...
new Choice(new Reference("Identifier"), new Reference("Literal"), new Reference("ThisExpression"), new Reference("GroupExpression")).setName("PrimaryExpression"),
...
new Action(new Sequence(new Optional(new Action(new Sequence(new Reference("Identifier").setName("value"), new Reference("_"), new Terminal(":")), (
function(__context, __values) {
let value = __values[0];
...
let property = __values[2];
 return {property, computed:false} })), new Action(new Sequence(new Terminal("."), new Reference("Identifier").setName("property")), (
function(__context, __values) {
...
function(__context, __values) {
let name = __values[0];
 return node('Identifier', {name}) })).setName("Identifier"),
