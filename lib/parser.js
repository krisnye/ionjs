...
var CustomPredicate = runtime.CustomPredicate
    ...
    function buildBinaryExpression(head, tail) {
       ...
       parser = new Parser(new Grammar([new Action(new Sequence(new Optional(new Reference("EOL")), new Optional(new Reference("ImportDeclarations")).setName("imports"), new Repeat(new Reference("Declaration")).setName("declarations"), new Reference("ExportStatement").setName("exports"), new Reference("EOL"), new Reference("EOF")), (
function(__context, __values) {
let imports = __values[1];
let declarations = __values[2];
let exports = __values[3];
 return node("Module", {imports:imports || [], declarations, exports}) })).setName("Module"),
...
new Choice(new Terminal("+"), new Terminal("-"), new Action(new Sequence(new Terminal("not").setName("value"), new Terminal(" "), new Reference("_")), (
function(__context, __values) {
let value = __values[0];
return value;}))).setName("UnaryOperator"),

new Choice(new Reference("MemberExpression"), new Action(new Sequence(new Reference("UnaryOperator").setName("operator"), new Reference("MemberExpression").setName("argument")), (
function(__context, __values) {
